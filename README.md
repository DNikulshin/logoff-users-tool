...
![Скриншот приложения](https://drive.google.com/file/d/1Xo65sAOD827V6S9ggldtQp0VVfqgRBb7/view?usp=sharing)
...
Приложение создает файл `settings.json` в той же папке, где находится исполняемый файл. Этот файл содержит три основные секции:
